...
import type { FaqItem } from "@/application/use-cases/get-saas-landing-data";
        ...
        {items.map((item) => (
          <Card key={item.question} className="overflow-hidden border-line bg-white/90">
            <details className="group">
              ...
              <div className="overflow-hidden px-6 pb-6 pt-0 text-foreground/70 transition-all duration-200">
                <p>{item.answer}</p>
              </div>
            </details>
          </Card>
