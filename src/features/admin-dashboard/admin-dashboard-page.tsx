...
export function AdminDashboardPage({ data }: AdminDashboardPageProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Metrics */}
      <AdminMetricsStrip
        contractsSigned={data.metrics.contractsSigned}
        creatorsTotal={data.metrics.creatorsTotal}
        validationTodo={data.metrics.validationTodo}
        paymentsTodo={data.metrics.paymentsTodo}
        totalToPay={data.metrics.totalToPay}
      />
