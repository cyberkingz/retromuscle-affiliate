...
export const metadata = createPageMetadata({
  title: "Inscription Programme Créateur RetroMuscle",
  description:
    "Crée ton compte et candidate au programme créateur. 95 à 180 EUR par vidéo validée, sans quota ni plafond.",
  path: "/apply"
});
