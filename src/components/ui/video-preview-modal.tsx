    ...
    >
      <DialogContent
        className={cn(
          ...
          // Close button (injected by Radix inside DialogContent) — make it visible on dark bg
          "[&>button:last-of-type]:text-white/50 [&>button:last-of-type]:hover:bg-white/10 [&>button:last-of-type]:hover:text-white [&>button:last-of-type]:z-30"
        )}
